...
function createScene() {
    ...
    // Add directional light and configure shadow properties
    ...
    // Uncomment the line below to visualize the shadow camera for debugging
    ...
    // Create cylinder and rings
    cylinder = createCylinder(4.5, 18);
    cylinder.castShadow = true;  // Ensure the cylinder casts shadows
    cylinder.receiveShadow = true;  // Ensure the cylinder receives shadows

    ring_1 = createRing(4.5, 7.5, -2, 1);
    ring_1.castShadow = true;
    ring_1.receiveShadow = true;
    level_1.add(ring_1);
    ...
    ring_2.castShadow = true;
    ring_2.receiveShadow = true;
    level_2.add(ring_2);
    ...
    ring_3.castShadow = true;
    ring_3.receiveShadow = true;
    level_3.add(ring_3);
    createRingFigures(12, -2, level_3, level_3_lights);
    level_3.position.set(0, 2, 0);
    scene.add(level_3);

    // Create Möbius strip and add lights
